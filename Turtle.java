...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    {
        bgcolor("black");
        bobbob bob1 = new bobbob(1);
        bobbob bob2 = new bobbob(2);
        bobbob bob3 = new bobbob(3);
        bob1.start();
        bob2.start();
        bob3.start();
    }
    static class bobbob extends Thread{
        int bobnumber;
        Turtle bob;

        public bobbob(int number){
            this.bobnumber = number;
            this.bob = new Turtle();
        }

        public void run() {
            switch (this.bobnumber) {
                case 1:
                    moon();
                    break;
                case 2:
